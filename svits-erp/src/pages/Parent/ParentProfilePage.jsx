...
import { MdEdit, MdSave, MdClose, MdEmail, MdPhone, MdLocationOn, MdPerson, MdFamilyRestroom } from 'react-icons/md'
import toast from 'react-hot-toast'
import '../Faculty/FacultyProfilePage.css' // Reuse CSS
...
const WARD_INFO = [
  ...
  { label: 'Roll Number',    key: 'wardRollNo' },
]
...
export default function ParentProfilePage() {
  ...
  return (
    <div className="fac-profile-page animate-fade-in" id="parent-profile-page">
      {/* Profile Banner */}
      <div className="fac-profile-banner animate-fade-in">
        ...
        <div className="fac-profile-banner-content">
          <div className="fac-profile-avatar-wrap">
            ...
            <div className="fac-profile-avatar-badge"><MdFamilyRestroom size={16} style={{ color: '#fff' }} /></div>
          </div>
          <div className="fac-profile-banner-info">
            <h1 className="fac-profile-name">{user?.name}</h1>
            <p className="fac-profile-meta">Parent Portal</p>
          </div>
